  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-5 lg:px-8 pt-24 pb-20 lg:pt-32 lg:pb-28 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:items-center">
          <div>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <Link href="/" className="v2-ghost-btn px-5 py-3">Go to the registry ↗</Link>
            </div>
      ...
      <Reveal as="section" stagger className="max-w-6xl mx-auto px-5 lg:px-8 py-20 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        <PreviewCard href="/v2/history" title="History" body="Founded 1976 — from Lagos's westward growth to a defining Surulere identity." />
        <PreviewCard href="/v2/leadership" title="Leadership" body="The Executive Chairman and the Council's Legislative Arm." />
        <PreviewCard href="/v2/departments" title="Departments" body="How a Lagos LG Secretariat is typically organised, office by office." />
        <PreviewCard href="/v2/wards" title="Wards & CDAs" body="Every ward and Community Development Association on record." />
        <PreviewCard href="/v2/news" title="News & activities" body="Sample coverage of the kind of updates a live portal would carry." />
        <PreviewCard href="/v2/contact" title="Contact" body="How residents would reach the Secretariat." />
      </Reveal>
    </>
  );
}
