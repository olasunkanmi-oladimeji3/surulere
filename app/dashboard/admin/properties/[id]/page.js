...
export default function PropertyProfilePage() {
  ...
  function removeTenant(unitId) {
    ...
    removeTenantFromUnit(user.id, propertyId, unitId); // notifies the store
  }
                ...
                <div className="min-w-0">
                  ...
                  {tenant && (
                    <div className="mt-2 text-sm">
                      <Link href={`/resident/${tenant.id}`} className="text-ink font-medium hover:text-brass hover:underline">
