...
export default function Modal({ open, onClose, title, children, size = "md" }) {
  ...
  return (
    <div
      className="fixed inset-0 bg-ink/50 backdrop-blur-sm z-30 flex items-center justify-center px-5 py-8"
      onMouseDown={(e) => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div
        className={`card w-full ${SIZES[size] || SIZES.md} bg-surface max-h-full flex flex-col`}
